...
if [ ! -d ${kernel_name} ]; then
	...
	cd ${kernel_name}
	git init
	git remote add origin https://git.launchpad.net/~ubuntu-kernel/ubuntu/+source/linux/+git/bionic
	#git remote add origin https://github.com/linuxium/ubuntu-bionic.git
